...
<body>
    <div class="content">
        ...
        <br/><br/>5. <a target="_blank" href="{{url('fire-webhook')}}">fire webhook</a>. Fire a webhook with "test data" to receive webhook URI and show the response here.
        <br/><br/>6. <a target="_blank" href="{{url('receive-webhook')}}">fire webhook</a>. Receive a webhook from fire webhook URL then save and show the last response.
        <br/><br/>7. <a target="_blank" href="{{url('animation')}}">animation</a>. Animate a box from the top-left edge of window to the bottom-right edge of window, which will return by the same way from the edge.
        <br/><br/>8. <a target="_blank" href="{{url('i-m-funny')}}">i-m-funny</a>. Enlisted the answers.
